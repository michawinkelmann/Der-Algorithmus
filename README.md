...
- **Anzeigen** (politische + kommerzielle, gekennzeichnet)
- **Bots** und Fake-Accounts
- **Gilden** — Gaming Nord, Leserunde 2028, Echte Werte (mit Inhaltswarnung), plus Hate-Incident
...
- **Lea** (Café Hafen) — 6 Nachrichten, 2 Antwort-Slots. W14-Antwort „Der Feed macht was mit mir" zählt für das Selbstbewusst-Ending.
- **Finn** (Gaming) — 6 Nachrichten, 2 Antwort-Slots. Radikalisierungs-Pfad oder Rettung — je nach Antwort. Zählt für Finn-Lost / Finn-Saved-Endings.
- **Marc Stay-Based** — Anwerbung W11, Nachhak in W14 und W18 (bedingt durch W11-Wahl).
...
- **„Klassen-Vergleich"** — alle SuS-JSONs hochladen, bekommt:
  ...
  - Tabelle pro Spieler:in (mit Greifshafen-Codenamen wie „Möwe", „Anker", „Fähre" wenn anonymisiert)
...
### Sicherheit
- **Auto-Backup** vor jedem Reset / Import — Wiederherstellung im Settings
- **Spielstand-Import** für SuS-Wechsel zwischen Geräten
...
- 🏅 Tief im Loch (Rabbit Hole), Bücherwurm (Leserunde)
